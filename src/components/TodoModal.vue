<template>
  <section
    data-cy="modal-add"
    class="flex flex-col items-center justify-center w-full bg-white rounded-lg sm:max-w-xl"
  >
    <div
      class="flex items-center justify-between w-full p-5 border-b modal-header"
    >
      ...
      <font-awesome-icon
        ...
        class="p-1 cursor-pointer fa-lg"
      />
    </div>
    <div class="flex flex-col justify-start w-full p-5 modal-body">
      <div class="flex flex-col justify-start input-wrapper">
        <label
        ...
        <input
          ...
          name="title"
          id="title"
          class="w-full px-4 py-3 mt-2 border border-gray-300 rounded-md"
          placeholder="Tambahkan nama list item"
          required
        />
      </div>
      <div class="flex flex-col justify-start mt-4 input-wrapper">
        <label
        ...
        <div class="relative mt-4 min-w-[150px]">
          <a
            ...
            class="flex items-center px-4 py-3 mt-2 border border-gray-300 rounded-md cursor-pointer max-w-fit"
          >
          ...
          >
            <a
              ...
              class="flex items-center w-full px-4 py-3 cursor-pointer hover:bg-gray-200"
            >
    ...
    <div
      class="flex justify-end w-full p-5 text-lg font-bold border-t modal-footer"
    >
      <button
        data-cy="modal-add-save-button"
        @click="saveTodo"
        class="px-12 py-3 ml-3 text-white bg-blue-500 rounded-full"
